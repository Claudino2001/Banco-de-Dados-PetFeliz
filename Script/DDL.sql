...
alter table
    tb_empregado
add
    constraint empregado_unique1 unique (cpf);
    
alter table
    tb_empregado
add
    constraint empregado_unique2 unique (rg);
    
alter table
    tb_empregado
add
    constraint empregado_unique3 unique (email);
    
alter table
    tb_cliente
add
    constraint cliente_unique1 unique (cpf);
